...
public class BLSMove {
    ...
    public boolean equals(Object o) {
        ...
        BLSMove blsMove = (BLSMove) o;
        return primaryVertex == blsMove.primaryVertex
                && type == blsMove.type
                && Objects.equals(removedVertices, blsMove.removedVertices);
    }
    ...
    public boolean isRemoval() {
        return type == BLSMoveType.REMOVAL;
    }

    public boolean isSwap() {
        return type == BLSMoveType.SWAP;
    }

    public boolean isAddition() {
        return type == BLSMoveType.ADDITION;
    }
