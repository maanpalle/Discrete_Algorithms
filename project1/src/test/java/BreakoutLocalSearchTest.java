...
class BreakoutLocalSearchTest {
    ...
    void getOM_withEmptyClique_returnsAllVertices() {
        ...
        BreakoutLocalSearch breakoutLocalSearch = new BreakoutLocalSearch(0);
        List<int[]> result = breakoutLocalSearch.getOM(graph0, clique);
    ...
    void getOM_withFullClique_returnsEmptySet() {
        ...
        BreakoutLocalSearch breakoutLocalSearch = new BreakoutLocalSearch(0);
        List<int[]> result = breakoutLocalSearch.getOM(graph1, clique);
    ...
    void getOM_withPartialClique_returnsCorrectSet() {
        ...
        BreakoutLocalSearch breakoutLocalSearch = new BreakoutLocalSearch(0);
        List<int[]> result = breakoutLocalSearch.getOM(graph2, clique);

        // Expect vertex 4 to not be part of the clique and vertex 3 to be part of the clique
        assertArrayEquals(new int[]{4, 3}, result.get(0));
    }
